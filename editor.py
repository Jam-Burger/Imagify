...
Label(main_frame, text="-"*36, font=('Consolas')).grid(row=1, column=0, columnspan=4)
...
Label(main_frame, text="Undo").grid(row=5, column=1)
...
Label(main_frame, text="Redo").grid(row=5, column=2)
