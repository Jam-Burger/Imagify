...
file_menu.add_command(label="Exit", command=lambda: fns.quit(root), accelerator="Ctrl+Q")
...
img_window = Canvas(img_window_frame, width=i_f_h, height=i_f_w, bg='black', highlightthickness=0)
...
Label(middle_frame, text="-"*50, font=('Consolas')).grid(row=1, column=0, columnspan=4)
...
rotate_a_btn = Button(main_frame, image=my_images.rotate_a_img, command=fns.rotate_a_img)
rotate_a_btn.grid(row=2, column=0)

rotate_c_btn = Button(main_frame, image=my_images.rotate_c_img, command=fns.rotate_c_img)
rotate_c_btn.grid(row=2, column=1)

Label(main_frame, text="Rotate").grid(row=3, column=0, columnspan=2)

flip_h_btn = Button(main_frame, image=my_images.flip_h_img, command=fns.flip_h_img)
flip_h_btn.grid(row=2, column=2)

flip_v_btn = Button(main_frame, image=my_images.flip_v_img, command=fns.flip_v_img)
